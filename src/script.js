...
const directionLight = new THREE.DirectionalLight(0x00fffc, 1)
...
const pointLight = new THREE.PointLight(0xff9000, 1.5, 20, 3)
...
const spotLight = new THREE.SpotLight(0x78ff00, 6, 10, Math.PI * .1, .25, 1 )
